...
def games_players_streamlined():
    from services.games_enhanced import games_streamlined_players
    return games_streamlined_players()


@views.route("/games/quick-log")
@login_required
def games_quick_log():
    from services.games_enhanced import games_quick_log
    return games_quick_log()
