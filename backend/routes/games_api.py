...
from models import GameSession, GamePod, User
...
def quick_pod_create():
    ...
    from services.games_enhanced import api_quick_pod_create
    return api_quick_pod_create()
...
def auto_assign_decks():
    ...
    from services.games_enhanced import api_auto_assign_decks
    return api_auto_assign_decks()
...
def quick_game_save():
    ...
    from services.games_enhanced import api_quick_game_save
    return api_quick_game_save()
