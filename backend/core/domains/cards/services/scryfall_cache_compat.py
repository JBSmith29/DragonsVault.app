"""
Monkeypatch core.domains.cards.services.scryfall_cache to accept flexible signatures used in routes:
...
try:
    from core.domains.cards.services import scryfall_cache as sc  # type: ignore
