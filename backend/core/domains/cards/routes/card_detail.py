...
from core.domains.cards.services import card_detail_service
from core.routes.base import views


@views.route("/cards/<int:card_id>")
def card_detail(card_id):
    return card_detail_service.card_detail(card_id)


@views.route("/cards/<id_or_sid>")
def smart_card_detail(id_or_sid):
    return card_detail_service.smart_card_detail(id_or_sid)
