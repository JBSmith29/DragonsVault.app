...
def create_app():
    ...
    @click.option("--quantity-mode", type=click.Choice(["absolute", "delta"]), default="absolute", show_default=True,
                  help="absolute: set quantity to file value; delta: add to existing.")
